...
export class BooksService {
    ...
    public booksControllerGet(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Book>('get',`${this.basePath}/api/v1/books/${encodeURIComponent(String(id))}`,
            {
    ...
    public booksControllerGetList(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Book>>('get',`${this.basePath}/api/v1/books`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
